/*
die6.c - Display die 6 of a roll of dice  Version 0.1.0
...
void die6(int left, xxfmt *xx)
   ...
   if (lean)
      ...
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+05,42,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+05,60,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+40,25,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+40,42,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
      ...
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+05,25,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+22,25,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+40,25,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+05,60,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+22,60,15,15,0,CIRCLE);
      XFillArc(xx->dpy,xx->w,xx->gc,
         left+40,60,15,15,0,CIRCLE);
      } /* if horizontal */
   } /* die6 */
