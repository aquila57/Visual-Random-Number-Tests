/*
rugen.c Version 0.1.0. Random dots generator, RANDU
...
int main()
   ...
   while(i--)   /* generating loop */
      ...
      seed *= EMM;
      x = seed >> 27;   /* set random column 0 to 511 */
      seed *= EMM;
      y = seed >> 27;   /* set random row    0 to 511 */
      seed *= EMM;
      z = seed >> 27;   /* set random row    0 to 511 */
      /* if one, erase the pixel at x,y */
      seed *= EMM;
      bit = seed >> 31;      /* choose black or white dot */
      cube[x][y][z] = bit;
      } /* for each sample */
   /**************************************************************/
